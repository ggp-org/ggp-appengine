package org.ggp.galaxy.shared.website;
...
public abstract class CachedStaticServlet extends HttpServlet {
    private static final String cacheName = "theCache"; 
    ...
    private final String getContentType(String theURL) {
        if (theURL.endsWith(".xml")) {
        	...
        	return getContentTypeForUnknown(theURL);
        }
    }
